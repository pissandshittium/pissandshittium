...
<<<<<<< HEAD:chrome/browser/touch_to_fill/payments/android/touch_to_fill_delegate_android_impl.cc
                              ServerFieldType::CREDIT_CARD_NUMBER) {
=======
                              FieldType::CREDIT_CARD_NUMBER) {
>>>>>>> 511b16a33b04d1a1daa8e1b5016282dabb45035b:chrome/browser/touch_to_fill/autofill/android/touch_to_fill_delegate_android_impl.cc
      return false;
    }
