 ...
 */
<<<<<<< HEAD:ios/chrome/browser/autofill/bottom_sheet/resources/bottom_sheet.ts
function attachListeners(renderer_ids: number[]): void {
=======
function attachListeners(
    renderer_ids: number[], allow_autofocus: boolean): void {
>>>>>>> 511b16a33b04d1a1daa8e1b5016282dabb45035b:ios/chrome/browser/autofill/model/bottom_sheet/bottom_sheet.ts
