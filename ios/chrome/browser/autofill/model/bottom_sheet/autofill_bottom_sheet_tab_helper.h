...
<<<<<<< HEAD:ios/chrome/browser/autofill/bottom_sheet/autofill_bottom_sheet_tab_helper.h
      const std::string& frame_id);
=======
      const std::string& frame_id,
      bool allow_autofocus);
>>>>>>> 511b16a33b04d1a1daa8e1b5016282dabb45035b:ios/chrome/browser/autofill/model/bottom_sheet/autofill_bottom_sheet_tab_helper.h
