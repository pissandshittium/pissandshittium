...
##############################################
pkgname=pissandshittium
pkgver=69420
pkgrel=1
pkgdesc="The browser that doesn't give a SHIT."
arch=('x86_64')
url='https://pissandshittium.org'
license=('BSD')
depends=(
...
#  "https://commondatastorage.googleapis.com/chromium-browser-official/chromium-${pkgver}.tar.xz"
  "chromium::git+https://github.com/Pissandshittium/pissandshittium"
  'git+https://github.com/foutrelis/chromium-launcher.git'
  'git+https://chromium.googlesource.com/chromium/tools/depot_tools.git#branch=main'
  'https://pissandshittium.org/pissandshittium.svg'
  'https://aur.archlinux.org/cgit/aur.git/plain/gclient_args.gni?h=chromium-dev'
  # Patch form Gentoo.
  ...
  'https://aur.archlinux.org/cgit/aur.git/plain/system-opus.diff?h=chromium-dev'
)
sha256sums=(
...
package() {
  ...
  install -Dm644 "${srcdir}/pissandshittium.svg" "${pkgdir}/usr/share/icons/hicolor/scalable/apps/chromium-dev.svg"
